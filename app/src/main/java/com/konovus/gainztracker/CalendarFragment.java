...
import com.konovus.gainztracker.databinding.FragmentCalendarBinding;
...
public class CalendarFragment extends Fragment implements WorkoutAdapter.WorkoutListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewStub = view.findViewById(R.id.stub_calendar);
...
//        calendarSetup();
    ...
    private void getWorkouts(){
        ...
        compositeDisposable.add(WorkoutDatabase.getDatabase(getContext()).workoutDao().getAllWorkouts()
    ...
    private void recyclerViewSetup(){
        if(workouts == null)
            workouts = new ArrayList<>();
        adapter = new WorkoutAdapter(getFilteredWorkouts(calendar.getCurrentPageDate().get(Calendar.MONTH)), getContext(), this);
    ...
    private class CalendarSetupAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            calendar.setForwardButtonImage(ContextCompat.getDrawable(getContext(), R.drawable.ic_arrow_right));
            calendar.setPreviousButtonImage(ContextCompat.getDrawable(getContext(), R.drawable.ic_arrow_left));
            ...
            if(workouts != null)
                for(Workout workout : workouts){
                    try {
                        ...
                        calendarDay.setBackgroundDrawable(ContextCompat.getDrawable(getContext(), R.drawable.bg_selected_day_cal_gradient));
